/*
	simple simulation of the chaos game, needs raylib graphic library to compile
*/
...
double Init(double side_lenght, double originX, double originY, double *top_vertexX, double *top_vertexY)
{
    ...
    *top_vertexX=originX+(side_lenght/2);
    ...
    BeginDrawing();
        DrawLine(originX, originY, originX+side_lenght, originY, BLACK);
        DrawLine(originX, originY, *top_vertexX, *top_vertexY, BLACK);
        DrawLine(originX+side_lenght, originY, *top_vertexX, *top_vertexY, BLACK);
    EndDrawing();
